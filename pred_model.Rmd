...
Due to the limitations of the data with regard to clustering, we instead did more exploratory analysis with dimension reduction (principal components analysis) to help us better understand the features and improve our answers to question #2 and #3. We focused our analysis on questions #2 and #3. 
